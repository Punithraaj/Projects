...
public class IPCluster2 implements ActionListener {

	JFrame jf = new JFrame("Cluster-2");
	Container c;
	...
	IPCluster2() {
		...
		l1 = new JLabel("Node-9");
		l2 = new JLabel("Node-10");
		l3 = new JLabel("Node-12");
		l4 = new JLabel("Node-13");
		l5 = new JLabel("Node-14");
